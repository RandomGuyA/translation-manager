<?php require_once "../../php/init.php"; ?><html><head><meta charset="utf-8"><title>SAFETY AND GENERAL GUIDANCE - Brecon Beacons National Park, Wales</title><script type='text/javascript' src='../../js/main.min.js'></script></head><body><div class="main-content clearfix">
<!--SearchStart//-->
<h1>SAFETY AND GENERAL GUIDANCE</h1>
<div class="article-video right clearfix"/>
<p>Beacons Way passes through several remote areas and great care should be taken to follow these sections safely. Prior preparation, route research and trip planning will avoid the majority of the pitfalls, but some specific points should be considered before undertaking the route.</p><ul>
<li>There is limited mobile phone coverage within the National Park, so a mobile phone should not be relied upon in the event of an emergency</li>
<li>If you need a taxi, it is best to pre-book it and phone to confirm somewhere with mobile reception (better on the top of a hill) before getting to the meeting point.</li>
...
<ul>
<li>Carry equipment that is relevant to the expected conditions. Ensure you are properly clothed and equipped</li>
<li>Clothing: warm, windproof layers, good waterproofs, a warm hat and gloves in cold weather, a hat with a brim for sun</li>
<li>Footwear: walking boots or walking shoes are essential; sandals and trainers are not suitable for mountain walking</li>
<li>Navigation: map, compass, GPS (make sure you know how to use them), route card, mobile phone</li>
<li>Health and safety: first aid kit, plenty of water, a hot flask in winter, chocolate or sweets for an energy boost, in addition to your lunch and snacks</li></ul>Extras: pencil and paper, torch, survival bag and/or Group Shelter, spare clothes&nbsp; 
