<?php require_once "../../php/init.php"; ?><html><head><meta charset="utf-8"><title>About the Brecon Beacons International Dark Sky Reserve - Brecon Beacons National Park, Wales</title><script type='text/javascript' src='../../js/main.min.js'></script></head><body><div class="main-content clearfix">
<!--SearchStart//-->
<h1>About the Brecon Beacons International Dark Sky Reserve</h1>
<div class="article-video right clearfix"/>
<p/><p>
<span style="font-size:18px;">Now that the entire Brecon Beacons National Park is an International Dark Sky Reserve, we intend to preserve our night skies, reduce energy wastage, help protect nocturnal wildlife and hold events related to the fascinating topic of astronomy. You're very welcome to come and experience our dark skies for yourself.</span></p>
<h2>
<img src="/website/var/tmp/thumb_1168__auto_450078387bf1c6122aa1db3e318c6c98.jpeg" style="width: 704px; height: 528px; margin-top: 15px; margin-bottom: 15px; float: right;"/>What is an International Dark Sky Reserve?</h2>
<p>Dark Sky Reserve status is a prestigious award given to only a handful of destinations that can prove they have an outstanding quality of night sky. They must also pledge to reduce light pollution to enhance the quality of this amazing asset.</p>
<h2>Who awards this status?</h2>
<p>The award is given by the International Dark Sky Association (IDA), a United States based non-profit organization founded in 1988. Its mission is "to preserve and protect the night-time environment and our heritage of dark skies through quality outdoor lighting." To find out more about what we've been up to to secure this status download our
...
<h2>Find out more</h2>
<p>
<a href="http://www.breconbeacons.org/stargazing-find-out-more">Click here</a>to find out what's happening in the sky this month and discover how you can find out more about astronomy and enjoy our beautiful dark skies!</p>
