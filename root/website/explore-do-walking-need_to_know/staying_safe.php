<?php require_once "../../php/init.php"; ?><html><head><meta charset="utf-8"><title>Staying safe - Brecon Beacons National Park, Wales</title><script type='text/javascript' src='../../js/main.min.js'></script></head><body><div class="main-content clearfix">
<!--SearchStart//-->
<h1>Staying safe</h1>
<div>
...
<div>
<span style="font-family:trebuchet ms,helvetica,sans-serif;">Be sure that the activity is suitable for all members of the group before you set out. Professional leaders should have first-aid and navigation skills, but if you are a social/family group make sure everyone knows where you are heading and the basic route. Keep together and proceed at the pace of the slowest person. Never abandon anyone because they can't keep up or let members race ahead out of site. Finally, take a group shelter just in case of sudden changes in the weather.</span></div>
<div>&nbsp; </div>
<div>
<span style="font-family:trebuchet ms,helvetica,sans-serif;"><strong>If you need help</strong></span></div>
<div>
<span style="font-family:trebuchet ms,helvetica,sans-serif;">If it is an emergency call 999 and ask for the Mountain Rescue, only the police can alert Mountain Rescue. If it is not an emergency, perhaps ask a a friend to pick up tired walkers or change your route and head to one of the local villages to seek transport back to your start point/vehicle.</span></div>
<div>&nbsp; </div>
<div>
<span style="font-family:trebuchet ms,helvetica,sans-serif;"><strong>Follow the Countryside Code at all times&nbsp; </strong></span></div>
<div>
<span style="font-family:trebuchet ms,helvetica,sans-serif;">For full details, please visit the Countryside Code website.</span></div>
<div>&nbsp; </div>
<h4>&nbsp; </h4>
<div>&nbsp; </div>
<!--SearchEnd//-->
