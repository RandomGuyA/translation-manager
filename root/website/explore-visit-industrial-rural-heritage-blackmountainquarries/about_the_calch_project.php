<?php require_once "../../php/init.php"; ?><html><head><meta charset="utf-8"><title>About the CALCH project - Brecon Beacons National Park, Wales</title><script type='text/javascript' src='../../js/main.min.js'></script></head><body><div class="main-content clearfix">
<!--SearchStart//-->
<h1>About the CALCH project</h1>
<div class="article-video right clearfix"/>
<p>Over three years starting in 2012 the Black Mountain Quarries were the core of the CALCH project, an investigation into the history and archaeology of the lime industry in Carmarthenshire. A joint project between the Brecon Beacons National Park, Dyfed Archaeological Trust, the National Museum of Wales and the Black Mountain Centre, the project has brought the quarries back to life through a series of projects and investigations.
<br/>&nbsp; 
