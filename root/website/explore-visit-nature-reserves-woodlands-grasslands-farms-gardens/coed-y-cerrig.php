<?php require_once "../../php/init.php"; ?><html><head><meta charset="utf-8"><title>Coed-y-Cerrig - Brecon Beacons National Park, Wales</title><script type='text/javascript' src='../../js/main.min.js'></script></head><body><div class="main-content clearfix">
<!--SearchStart//-->
<h1>Coed-y-Cerrig National Nature Reserve</h1>
<div class="article-video right clearfix"/>
<p/><p>
<span style="font-size:18px;">In the Brecon Beacons National Park north of Abergavenny, this varied woodland contains magnificent beeches, bluebells and butterflies.</span></p>
<p>
<img src="/website/var/tmp/thumb_383__auto_450078387bf1c6122aa1db3e318c6c98.jpeg" style="width: 704px; margin-top: 15px; margin-bottom: 15px; float: right; height: 528px;"/>The name given to this mysterious, deeply wooded narrow valley, Coed-y-Cerrig (Wood of Stones), hints at the glacial activity that took place here during the last Ice Age, when an ice sheet dramatically divided around the Black Mountains to reach Hereford in the north and Raglan in the south.</p>
...
<p>The former railway line was surfaced over many years ago to create the road that divides the reserve. There is a small car park. A flat boardwalk which takes the visitor around the wet woodland is accessible to individuals of all levels of mobility, with turning-points provided at regular intervals. The dry woodland is quite different: a steepish path leads through the trees to the top, where holly has begun to thrive once more since grazing ceased.</p>
<h3>How to get there</h3>
<p>Leave the A465 at Crucorney and take the road to Llanthony. After 1.25 miles turn left towards Forest Coal Pit. The reserve entrance is another 1.25 miles on the right, but can easily be missed. Visitors can take a short walk around the boardwalk in the wet woodland. A range of circular walks are also possible, both within the reserve and out into the surrounding countryside.</p>
