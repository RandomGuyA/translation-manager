<?php require_once "../../php/init.php"; ?><html><head><meta charset="utf-8"><title>Black Mountains: Castell Dinas and the Gliding Club - Brecon Beacons National Park, Wales</title><script type='text/javascript' src='../../js/main.min.js'></script></head><body><div class="main-content clearfix">
<!--SearchStart//-->
...
<p style="margin: 0px 0px 0.75em; line-height: 1.5em; color: rgb(85, 85, 85); font-family: 'Lucida Grande','Lucida sans',Arial,Helvetica,sans-serif; font-size: 14px; background-color: rgb(193, 214, 255);">11.00 - 13.00 Walk up to Castell Dinas and enjoy the views as a reward for your labours.
<br/>13.00 - 14.00 Either lunch at the Castle Inn, Pengenfford or return to Talgarth to find lunch.
<br/>14.00 - 16.00 Visit the Black Mountains Gliding Club and either watch an afternoon's soarinng - or if you have pre-booked enjoy a trial lesson.</p>
<h3>Where is it?</h3>
<p>
<span style="font-family: trebuchet ms,helvetica,sans-serif;"><span style="font-size: 14px;"><strong>The Castle Inn</strong>, Pengenffordd, near talgarth ld3 0eP www.brecon-beaconsaccommodation.co.uk
...
<br/>
<br/>
<strong>Castell Dinas</strong>is accessed via a steep and un-even footpath and has no facilities.
<br/>
<br/>
...
<a href="http://www.traveline-cymru.org.uk">www.traveline-cymru.org.uk</a>for the latest travel information and timetables. during the summer months the Beacons Bus service also passes through talgarth on sundays and Bank holiday Mondays from the end of May to the beginning of october. see www.travelbreconbeacons.info
<br/>for more details.</span></span><span style="font-family: trebuchet ms,helvetica,sans-serif;"><span style="font-size: 14px;"><img src="/all_images_in_here_please/great_days_out/itineraries/logo_for_itineraries.png" style="width: 200px; height: 110px; margin: 8px; float: right;"/></span></span><br/>
<br/>
<span style="font-family: trebuchet ms,helvetica,sans-serif;"><span style="font-size: 14px;"><strong>By bike</strong>: National route 8 passes through talgarth.</span></span><br/>&nbsp; </p>
