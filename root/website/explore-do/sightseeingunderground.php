<?php require_once "../../php/init.php"; ?><html><head><meta charset="utf-8"><title>Sightseeing Underground - Brecon Beacons National Park, Wales</title><script type='text/javascript' src='../../js/main.min.js'></script></head><body><div class="main-content clearfix">
<!--SearchStart//-->
<h1>Sightseeing underground</h1>
<div class="article-video right clearfix"/>
<p/><div>
<em><strong>Discover an underground world of beautiful natural playgrounds waiting to be explored!</strong></em></div>
<div>&nbsp; </div>
<div>
<em><strong><img src="/website/var/tmp/thumb_7031__auto_850904660de984af948beee3aee98a4f.jpeg" style="width:600px;"/></strong></em></div>
<div>&nbsp; </div>
<div>
...
<br/>Guided trips are available leaving at 10.00 in the morning and 13.30 in the afternoon on the following dates:</div>
<ul>
<li>April &nbsp;  2&nbsp; </li>
<li>May &nbsp; 31</li>
<li>June &nbsp;  2&nbsp; </li>
...
<li>August 28</li></ul>
<div>
<br/>You can book onto one of the trips to spend a half day underground.&nbsp; 
<br/>
<a href="/sightseeing-underground-booking" style="font-size: 16px; font-family: 'trebuchet ms', helvetica, sans-serif;">Book online here</a></div>
<div>&nbsp; </div>
