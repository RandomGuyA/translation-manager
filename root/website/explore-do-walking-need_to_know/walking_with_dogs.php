<?php require_once "../../php/init.php"; ?><html><head><meta charset="utf-8"><title>Walking with dogs - Brecon Beacons National Park, Wales</title><script type='text/javascript' src='../../js/main.min.js'></script></head><body><div class="main-content clearfix">
<!--SearchStart//-->
<h1>Walking with dogs</h1>
<div class="landing-slider-wrap clearfix">
<ul class="landing-slider">
<li>
<img src="/website/var/tmp/thumb_2570__landing_slider.jpeg" alt="" title="" height="160" width="340"/></li>
<li>
...
<p>
<span style="font-family:trebuchet ms,helvetica,sans-serif;">At certain times dogs may not be allowed on some areas of open land or may need to be kept on a lead, so keep an eye out for any signs. You can also find out more about these rules from&nbsp; 
<a href="http://www.ccw.gov.uk/default.aspx">Natural Resources Wales.</a></span></p>
<!--SearchEnd//-->
